...
import { PoStatsComponent } from './po-stats/po-stats.component';
...
@Component({
    ...
    standalone: true,
    imports: [PoStatsComponent, RouterLink, MatCardModule, MatButtonModule, MatMenuModule, MatTableModule, NgIf, MatPaginatorModule],
